...
$url        = 'https://imsreleases.blob.core.windows.net/universal/production/5.6.12/PowerShellUniversal.5.6.12.msi'
...
$packageArgs = @{
  ...
  checksum      = '2F3E2A07536EAC02F85E689703FBE5ACEEED1818BE8B32E582DC1AC796E953C3'
  checksumType  = 'sha256'
