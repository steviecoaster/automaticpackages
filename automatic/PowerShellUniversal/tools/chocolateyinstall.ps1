...
$url        = 'https://imsreleases.blob.core.windows.net/universal/production/2026.1.5/PowerShellUniversal.2026.1.5.msi'
...
$packageArgs = @{
  ...
  checksum      = '8B7D70F1F75E8BD1F64066FFBE39DC458066583DB3F85D713BD27B7C96663046'
  checksumType  = 'sha256'
